...
public class Triangle extends GeometricObject {
    ...
    public void scale(float Factor) {
        this.getPointB().setXCoord((int)Math.round(this.getPointB().getXCoord() * Factor), false);
        this.getPointB().setYCoord((int)Math.round(this.getPointB().getYCoord() * Factor), false);
        this.getPointC().setXCoord((int)Math.round(this.getPointC().getXCoord() * Factor), false);
        this.getPointC().setYCoord((int)Math.round(this.getPointC().getYCoord() * Factor), false);
    }
