...
public class Button extends Rectangle {
    ...
    public void set_Pos_Top_Left_in_proz(float top_proz, float left_proz, float width_proz, float height_proz) {
        ...
        this.getPointA().setXCoord(pixel_left_proz);
        this.getPointA().setYCoord(pixel_top_proz);
        this.getPointB().setXCoord(pixel_left_proz);
        this.getPointB().setYCoord(pixel_top_proz + pixel_height_proz);
        this.getPointC().setXCoord(pixel_left_proz + pixel_width_proz);
        this.getPointC().setYCoord(pixel_top_proz + pixel_height_proz);
        this.getPointD().setXCoord(pixel_left_proz + pixel_width_proz);
        this.getPointD().setYCoord(pixel_top_proz);
