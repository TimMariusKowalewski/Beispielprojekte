...
public class JOCLBandwidthTest {
	...
	/**
	 * Compute the bandwidth in MB/s for copying a chunk of memory of the
	 * given size from the host to the device with the given memory- and
	 * access mode
	 *
	...
	/**
	 * Perform a default initialization by creating a context and a command
	 * queue
	 */
