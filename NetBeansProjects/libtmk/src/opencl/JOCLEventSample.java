...
/**
 * A small sample demonstrating basic event handling and how to obtain profiling
 * information for a command queue.
 */
public class JOCLEventSample
{

    /**
     * Source code of a kernel that adds the components of two vectors and
     * stores the result in a third vector
     */
    final private static String programSource0
    ...
    /**
     * Source code of a kernel that multiplies the components of two vectors and
     * stores the result in a third vector
     */
    final private static String programSource1
    ...
    public static void main(String args[])
    {
        ...
        // Wie lange dauern die Operationen auf der CPU?
        long startTime = System.nanoTime();
        for (int i = 0; i < srcArrayA.length; i++)
        {
            dstArray0[i] = srcArrayA[i] + srcArrayB[i] * srcArrayA[i];
        }
        ...
        for (int i = 0; i < srcArrayA.length; i++)
        {
            dstArray1[i] = srcArrayA[i] * srcArrayB[i] * srcArrayA[i];
        }
        ...
        cl_program program0 = clCreateProgramWithSource(
            context,
            1,
            new String[]
            {
        ...
        // Parameter für unsere beiden Kernel festlegen0
        clSetKernelArg(
            kernel0,
            0,
            Sizeof.cl_mem,
...
//        };
    ...
    /**
     * A simple helper class for tracking cl_events and printing timing
     * information for the execution of the commands that are associated with
     * the events.
     */
